...
class TestCollectTrainValSamples(unittest.TestCase):
    ...
    def test_structure_and_content_graph(self):
        ...
        np.testing.assert_allclose(
            pred_vals["forces"],
            [
                [5.5237149354070425e-05, 6.52165908832103e-05, 3.8899645005585626e-05],
                [
                    -0.00014120482956059277,
                    -0.00022646744037047029,
                    0.0008619867730885744,
                ],
                [0.0006334616336971521, 0.0001841261109802872, 0.00020721399050671607],
                [
                    -0.00010912466677837074,
                    -0.00021900370484218001,
                    0.0002855587808880955,
                ],
                [5.887588486075401e-06, 0.0004124082624912262, -0.0005348525592125952],
                [0.0006676099728792906, -0.00012074444384779781, 0.0005881588440388441],
                [-0.0008001297246664762, 0.0004907971015200019, 2.7643302018987015e-05],
                [
                    -8.844767580740154e-05,
                    -0.00011240644380450249,
                    0.00012578023597598076,
                ],
                [0.000493224011734128, 0.00048270466504618526, -0.0003924377087969333],
                [
                    0.00010541544179432094,
                    -0.00010234814544674009,
                    4.2073370423167944e-05,
                ],
                [
                    -0.0004958420759066939,
                    -0.0003936649882234633,
                    -0.00036488918703980744,
                ],
                [0.0003016919654328376, 0.00011728252866305411, -8.422513928962871e-06],
                [
                    -0.0011386498808860779,
                    -0.00013032610877417028,
                    -0.0006526153301820159,
                ],
                [
                    -0.00010420788748888299,
                    -7.6639189501293e-06,
                    -0.00021884136367589235,
                ],
                [
                    -9.165264782495797e-05,
                    -0.00011998930131085217,
                    0.00035610480699688196,
                ],
                [0.0007067315746098757, -0.000319920654874295, -0.000361361016985029],
            ],
            rtol=1e-5,
            atol=1e-6,
        )
        self.assertAlmostEqual(pred_vals["energy"], 0.0002999076677951962, places=6)
        np.testing.assert_allclose(
            pred_vals["stress"],
