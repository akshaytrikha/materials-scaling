...
class TestCollectTrainValSamples(unittest.TestCase):
    ...
    def test_structure_and_content_graph(self):
        ...
        np.testing.assert_allclose(
            pred_vals["forces"],
            [
                [0.00017903500702232122, 0.0002420818927930668, 0.0001471853902330622],
                [
                    -0.0013830625684931874,
                    -0.00036091351648792624,
                    0.00018329417798668146,
                ],
                [
                    -0.00010354671394452453,
                    0.00022667497978545725,
                    0.00025556140462867916,
                ],
                [
                    -7.494926103390753e-05,
                    -0.00012792821507900953,
                    0.00030538783175870776,
                ],
                [0.00048119277926161885, -8.486914884997532e-05, 0.0006741558318026364],
                [-3.096327418461442e-05, 0.00032416131580248475, 9.468643111176789e-05],
                [-3.526857472024858e-05, 0.0005226668436080217, 9.520287858322263e-05],
                [
                    -0.00010818317969096825,
                    -0.00024693110026419163,
                    -0.00013156875502318144,
                ],
                [
                    0.00014510622713714838,
                    0.00023279216839000583,
                    -0.0002788054698612541,
                ],
                [-6.537354056490585e-05, 8.419947334914468e-07, -5.443695044959895e-05],
                [-0.0016843287739902735, -0.0009451116202399135, 0.0014430610463023186],
                [
                    -0.00011966493184445426,
                    7.880109478719532e-05,
                    -7.029662083368748e-05,
                ],
                [
                    0.0011466785799711943,
                    -0.00020637866691686213,
                    -0.0021573451813310385,
                ],
                [0.0010198528179898858, 0.0004032509750686586, -0.0007908312836661935],
                [7.137100328691304e-05, 0.00018796115182340145, 0.0004977533826604486],
                [
                    0.0005621043383143842,
                    -0.00024710013531148434,
                    -0.0002130040666088462,
                ],
            ],
            rtol=1e-5,
            atol=1e-6,
        )
        self.assertAlmostEqual(pred_vals["energy"], -0.00026154867373406887, places=6)
        np.testing.assert_allclose(
            pred_vals["stress"],
            [
                [
                    -0.00019490765407681465,
                    0.00035967526491731405,
                    0.0001523348328191787,
                    0.000569069292396307,
                    0.00026324554346501827,
